...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="w-[400px] gap-0 rounded-[20px] border border-border bg-popover p-0 py-5 text-center text-popover-foreground shadow-[0px_4px_11px_0px_rgba(0,0,0,0.08)] backdrop-blur-2xl">
